...
\subsection{Person Detection Performance}
\label{subsec:detection-results}

Table~\ref{tab:detection} shows the detection performance of YOLOv26m on the MTMMC dataset.

\begin{table}[htbp]
\caption{Person Detection Performance (YOLOv26m)}
\label{tab:detection}
\centering
\begin{tabular}{|l|c|}
\hline
...
\hline
mAP@0.5 & \textcolor{red}{[XX.X\%]} \\
\hline
mAP@0.5:0.95 & \textcolor{red}{[XX.X\%]} \\
\hline
Precision & \textcolor{red}{[XX.X\%]} \\
\hline
Recall & \textcolor{red}{[XX.X\%]} \\
\hline
\end{tabular}
\end{table}

\subsection{Tracking and Re-Identification Performance}
\label{subsec:tracking-results}

Table~\ref{tab:tracking} shows the tracking and re-identification results for both environments.

\begin{table}[htbp]
\caption{Tracking and Re-Identification Performance}
\label{tab:tracking}
\centering
\begin{tabular}{|l|c|c|}
\hline
\textbf{Metric} & \textbf{Campus} & \textbf{Factory} \\
\hline
MOTA & \textcolor{red}{[XX.X\%]} & \textcolor{red}{[XX.X\%]} \\
\hline
IDF1 & \textcolor{red}{[XX.X\%]} & \textcolor{red}{[XX.X\%]} \\
\hline
Rank-1 Accuracy & \textcolor{red}{[XX.X\%]} & \textcolor{red}{[XX.X\%]} \\
\hline
ID Switches & \textcolor{red}{[XXX]} & \textcolor{red}{[XXX]} \\
\hline
\end{tabular}
\end{table}
...
\hline
Person Detection & \textcolor{red}{[XX.X]} \\
\hline
Intra-Camera Tracking & \textcolor{red}{[XX.X]} \\
\hline
Spatial Matching & \textcolor{red}{[XX.X]} \\
\hline
Re-Identification & \textcolor{red}{[XX.X]} \\
\hline
\textbf{Total (per frame)} & \textbf{\textcolor{red}{[XX.X]}} \\
\hline
\end{tabular}
\end{table}
...
\begin{figure}[htbp]
    \centering
    % Placeholder for qualitative results image
    \framebox[\linewidth]{\rule{0pt}{1.5in} Qualitative Results Placeholder}
...
\begin{figure}[htbp]
    ...
    \framebox[\linewidth]{\rule{0pt}{1.5in} Performance Comparison Chart Placeholder}
...
\begin{figure}[htbp]
    ...
    \framebox[\linewidth]{\rule{0pt}{1.5in} Dashboard Screenshot Placeholder}
...
The IDF1 score, which is the primary metric for cross-camera identity consistency, reached \textcolor{red}{[XX.X\%]} on the campus environment and \textcolor{red}{[XX.X\%]} on the factory environment. The factory scenarios were more challenging due to \textcolor{red}{[uniform clothing / dense occlusions / lighting variations]}, which resulted in slightly lower scores.
