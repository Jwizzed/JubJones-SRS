...
To quantify the improvements provided by the SpotOn architecture, we established a baseline using a non-optimized pipeline. This baseline employs a standard PyTorch YOLOv8m detector and an exhaustive Re-ID strategy, where appearance features are extracted for every person in every frame. Table~\ref{tab:baseline_tracking} and Table~\ref{tab:baseline_latency} summarize the baseline accuracy and processing requirements.
