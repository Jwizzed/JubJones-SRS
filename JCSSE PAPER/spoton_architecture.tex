...
\begin{tikzpicture}[
    ...
    font=\sffamily\small,
    % Styles definition
    base/.style = {draw, align=center, inner sep=1.8ex, rounded corners=3pt, minimum width=3.4cm},
    input/.style = {base, fill=gray!20, font=\sffamily\bfseries},
    process/.style = {base, fill=white},
    decision/.style = {draw, diamond, aspect=1.4, fill=purple!10, text width=2.4cm, align=center, inner sep=0.5ex, font=\sffamily\footnotesize},
    output/.style = {base, fill=gray!20, font=\sffamily\bfseries, text width=3.8cm, minimum height=2.5cm},
    ...
    modtitle/.style = {font=\sffamily\bfseries, align=center}
]

% ====================
% COLUMN 1: Input Layer
% ====================
\node [input, fill=white] (vid) {\includegraphics[width=3cm]{input_frame.jpeg}\\[1ex]Video Frames};
...
\begin{scope}[on background layer]
    ...
    \node[modtitle, text=gray!80!black, above=5pt of input_layer] {Input Layer};
\end{scope}
...
\node [process, below=0.6cm of m1_3, fill=white, inner sep=1ex] (m1_4) {Output: BBox\\Coordinates\\[1ex]
    \includegraphics[height=1.1cm]{bbox1.png} \includegraphics[height=1.1cm]{bbox2.png} \includegraphics[height=1.1cm]{bbox3.png}\\[2pt]
    \includegraphics[height=1.1cm]{bbox4.png} \includegraphics[height=1.1cm]{bbox5.png} \includegraphics[height=1.1cm]{bbox6.png}
};
...
\begin{scope}[on background layer]
    ...
    \node[modtitle, text=red!70!black, above=5pt of mod1] {Module 1: Detection\\{[}YOLOv26m{]}};
\end{scope}
...
\node [process, below=0.6cm of m2_3, fill=white, inner sep=1ex] (m2_4) {Output: Local Track IDs\\[1ex]
    \includegraphics[height=1.1cm]{track1.png} \includegraphics[height=1.1cm]{track2.png} \includegraphics[height=1.1cm]{track3.png}
};
...
\begin{scope}[on background layer]
    ...
    \node[modtitle, text=green!60!black, above=5pt of mod2] {Module 2: Tracking\\{[}ByteTrack{]}};
\end{scope}
...
% ====================
% Module 3 (Top)
\node [process, right=3cm of dec.east, yshift=6cm] (m3_1) {Extract foot\\proxy coords};
...
\begin{scope}[on background layer]
    ...
    \node[modtitle, text=blue!70!black, above=5pt of mod3] {Module 3: Mapping\\{[}Homography{]}};
\end{scope}

\draw [arrow] (dec.north) |- node[above, near start, font=\sffamily\bfseries] {Yes} (mod3.west);

% Module 4 (Bottom)
\node [process, right=3cm of dec.east, yshift=-5cm] (m4_1) {Trigger: 5\%\\edge margin};
...
\node [process, below=0.6cm of m4_3, fill=white, inner sep=1ex] (m4_4) {Match if Cosine Sim $> 0.70$\\[1ex]
    \includegraphics[height=1.1cm]{reid1.jpeg} \includegraphics[height=1.1cm]{reid2.jpeg}
};
...
\begin{scope}[on background layer]
    ...
    \node[modtitle, text=orange!80!black, above=5pt of mod4] {Module 4: Re-ID\\{[}OSNet-AIN{]}};
\end{scope}

\draw [arrow] (dec.south) |- node[below, near start, font=\sffamily\bfseries] {No} (mod4.west);
