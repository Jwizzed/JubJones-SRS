...
All 38 frontend test cases and 50 backend test cases were verified and passed, confirming the system's functional completeness and reliability. Two key AI models, YOLO26m and FastReID (OSNet backbone), were fine-tuned and evaluated against the MTMMC dataset, and selected based on a principled comparison of performance metrics including mAP, Rank-1 accuracy, and inference latency.
