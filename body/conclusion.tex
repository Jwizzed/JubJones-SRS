...
\begin{enumerate}[leftmargin=80pt]
    \item \textbf{Multi-Stage AI Pipeline:} The backend integrates YOLO26m for high-accuracy person detection, ByteTrack for intra-camera temporal identity preservation, and a FastReID-based Re-Identification module for cross-camera identity resolution. Together, these components form a coherent and ordered processing pipeline that transforms raw video frames into structured tracking metadata.
