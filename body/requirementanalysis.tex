...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.8\textwidth,keepaspectratio]{jubjones/UI/LANDING.jpeg}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.8\textwidth,keepaspectratio]{jubjones/UI/ENV_SELECTION.png}
    \caption{Environment Selection}
    \label{fig:ui-env-selection}
\end{figure}

\begin{figure}[h!]
    \centering
    \includegraphics[width=0.8\textwidth,keepaspectratio]{jubjones/UI/VIDEO_FEED.jpeg}
    \caption{Video Feed Overview}
    \label{fig:ui-video-feed}
\end{figure}

\begin{figure}[h!]
    \centering
    \includegraphics[width=0.8\textwidth, keepaspectratio]{jubjones/UI/TRACK_ONE.jpeg} 
    \caption{Tracking View}
    \label{fig:ui-track-one}
\end{figure}

\begin{figure}[h!]
    \centering
    \includegraphics[width=0.8\textwidth, keepaspectratio]{jubjones/UI/ANALYTIC_01.png} 
    \caption{Analytics Dashboard - Overview}
    \label{fig:ui-analytic-01}
\end{figure}

\begin{figure}[h!]
    \centering
    \includegraphics[width=0.8\textwidth, keepaspectratio]{jubjones/UI/ANALYTIC_02.png} 
    \caption{Analytics Dashboard - Detailed Metrics}
    \label{fig:ui-analytic-02}
\end{figure}

\begin{figure}[h!]
    \centering
    \includegraphics[width=0.8\textwidth, keepaspectratio]{jubjones/UI/ANALYTIC_03.png} 
    \caption{Analytics Dashboard - Trends}
    \label{fig:ui-analytic-03}
\end{figure}

\begin{figure}[h!]
    \centering
    \includegraphics[width=0.8\textwidth, keepaspectratio]{jubjones/UI/HELP.png} 
    \caption{Help and Documentation}
    \label{fig:ui-help}
\end{figure}
\clearpage

The user interface presents a streamlined workflow designed for efficiency. The process begins at the \textbf{Landing Page} (Figure \ref{fig:ui-landing}), which serves as the entry point. Users then proceed to \textbf{Environment Selection} (Figure \ref{fig:ui-env-selection}), where they choose the specific campus or factory environment to analyze.

Once an environment is selected, the \textbf{Video Feed} (Figure \ref{fig:ui-video-feed}) displays the real-time or recorded camera streams, offering a comprehensive operational view. From here, users can enter the \textbf{Tracking View} (Figure \ref{fig:ui-track-one}), which allows for the specific monitoring of individuals across multiple cameras, utilizing the system's re-identification capabilities.

For deeper insights, the \textbf{Analytics Dashboard} (Figures \ref{fig:ui-analytic-01}, \ref{fig:ui-analytic-02}, \ref{fig:ui-analytic-03}) provides data-driven visualizations of movement patterns, detection statistics, and other key metrics. Finally, the \textbf{Help} section (Figure \ref{fig:ui-help}) offers documentation and support resources to assist users in navigating the system capabilities.
\newpage
...
\begin{itemize}[leftmargin=80pt]
    ...
    \item \textbf{Real-Time Data Processing:} The system needs to process live video feeds from multiple cameras in real-time. This capability is essential for immediate analysis of current events and synchronized movement tracking across the facility.
