...
\begin{itemize}
    ...
    \item \textbf{Feedback Loop:} Retrieval accuracy is continuously improved through automated measurement and feedback loops based on user confirmations.
\end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item The backend is deployed using a modular architecture with Docker containerization, orchestrated via Kubernetes to ensure scalability at scale.
    ...
    \begin{itemize}
        ...
        \item The CI/CD pipeline enforces evaluation-driven development, automatically running unit tests, regression tests, and load/performance tests before any Blue-Green deployment.
    \end{itemize}
\end{itemize}
